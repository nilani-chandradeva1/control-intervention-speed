...
#Fig 3
ggsave(plot_perennial, file = "2.ivm-prolonged-distr/plots/plot_perennial.pdf", dpi = 100)
ggsave(plot_perennial, file = "2.ivm-prolonged-distr/plots/plot_perennial.png")
