require(tidyverse)
df_distr_seasonal <- readRDS("2.ivm-prolonged-distr/output/df_distr_season_timed.rds")
df_distr_seasonal_late <- readRDS("2.ivm-prolonged-distr/output/df_distr_season_late.rds")
...
mv_plot_on_time <- ggplot(df_distr_seasonal, aes(x = (t - start)/365, y = mv, col = as.factor(model_type))) +
  ...
  xlab("Years since start of on-time \n MDA") +
...
#impact
impact_on_time <- readRDS("2.ivm-prolonged-distr/output/impact_seasonal_on_time.rds")
covs_error_on_time <- readRDS("2.ivm-prolonged-distr/output/impact_seasonal_covs_error.rds") %>%
  mutate(seasonality = "seasonal-on-time"  )


#impact-late
impact_late <- readRDS("2.ivm-prolonged-distr/output/impact_seasonal_late.rds")
cov_error_late <- readRDS("2.ivm-prolonged-distr/output/impact_seasonal_late_covs_error.rds")%>%
