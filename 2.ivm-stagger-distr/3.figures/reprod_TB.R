...
impact_df2 <- readRDS("2.ivm-stagger-distr/output/TB_impact_df2.rds")
covs_error_df <- readRDS("2.ivm-stagger-distr/output/TB_covs_error_df.rds")
...
ggplot()  +
  geom_bar_pattern(data = impact_df2,
                   ...
                   stat = "identity",
                   position = position_dodge2(preserve = "single", 0.9),
