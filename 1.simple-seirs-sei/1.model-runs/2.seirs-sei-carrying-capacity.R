...
params_base <- list(
  ...
  beta_hv = 0.3,            # Transmission prob. on human from vector
  beta_vh = 0.3,            # Transmission prob. on vector from human
...
write_rds(grid,"1.simple-seirs-sei/output/params_base_carrying_capacity.rds")
...
#grid_baseline <-  M0 = c(200000, 2000),
